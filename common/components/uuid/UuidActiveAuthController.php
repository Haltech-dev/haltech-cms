...
class UuidActiveAuthController extends ActiveController
{
    public function behaviors()
    {
        ...
        $behaviors['corsFilter'] = [
            // 'class' => \app\components\CustomCors::class,
    ...
    public function actions()
    {
        return [
            ...
            'create' => [
                'class' => 'common\components\uuid\CreateAction',
                'modelClass' => $this->modelClass,
                'checkAccess' => [$this, 'checkAccess'],
                'scenario' => $this->createScenario,
            ],
            'update' => [
                'class' => 'common\components\uuid\UpdateAction',
                'modelClass' => $this->modelClass,
                'checkAccess' => [$this, 'checkAccess'],
